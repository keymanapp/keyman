...
#ifndef __GTESTUTILS_H__
#define __GTESTUTILS_H__
...
void    km_g_test_disable_crash_reporting  (void);
...
void     km_g_test_trap_subprocess_with_envp (const char           *test_path,
...
#define  km_g_test_trap_assert_stdout(soutpattern)           km_g_test_trap_assertions (G_LOG_DOMAIN, __FILE__, __LINE__, G_STRFUNC, 2, soutpattern)
#define  km_g_test_trap_assert_stdout_unmatched(soutpattern) km_g_test_trap_assertions (G_LOG_DOMAIN, __FILE__, __LINE__, G_STRFUNC, 3, soutpattern)
#define  km_g_test_trap_assert_stderr(serrpattern)           km_g_test_trap_assertions (G_LOG_DOMAIN, __FILE__, __LINE__, G_STRFUNC, 4, serrpattern)
#define  km_g_test_trap_assert_stderr_unmatched(serrpattern) km_g_test_trap_assertions (G_LOG_DOMAIN, __FILE__, __LINE__, G_STRFUNC, 5, serrpattern)

/* provide seed-able random numbers for tests */
#define  km_g_test_rand_bit()              (0 != (km_g_test_rand_int() & (1 << 15)))
GLIB_AVAILABLE_IN_ALL
gint32   km_g_test_rand_int                (void);
GLIB_AVAILABLE_IN_ALL
gint32   km_g_test_rand_int_range          (gint32          begin,
                                         gint32          end);
GLIB_AVAILABLE_IN_ALL
double   km_g_test_rand_double             (void);
GLIB_AVAILABLE_IN_ALL
double   km_g_test_rand_double_range       (double          range_start,
                                         double          range_end);
