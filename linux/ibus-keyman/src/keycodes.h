...
static km_core_virtual_key const keycode_to_vk[256] = {
    ...
    0,                            // padding 0x54;
    KM_CORE_VKEY_KANA,            // 0x55 - KEY_ZENKAKUHANKAKU
    KM_CORE_VKEY_oE2,             // 0x56 - KEY_102ND
    KM_CORE_VKEY_F11,             // 0x57 - KEY_F11
    KM_CORE_VKEY_F12,             // 0x58 - KEY_F12
    0,                            // 0x59 - KEY_RO - ?
    KM_CORE_VKEY_KANA,            // 0x5a - KEY_KATAKANA
    KM_CORE_VKEY_KANA,            // 0x5b - KEY_HIRAGANA
    KM_CORE_VKEY_KANA,            // 0x5c - KEY_HENKAN
    KM_CORE_VKEY_KANA,            // 0x5d - KEY_KATAKANAHIRAGANA
    KM_CORE_VKEY_KANA,            // 0x5e - KEY_MUHENKAN
    ...
    0,                            // 0x70 - KEY_MACRO - ?
    KM_CORE_VKEY_VOLUMEMUTE,      // 0x71 - KEY_MUTE
    KM_CORE_VKEY_VOLUMEDOWN,      // 0x72 - KEY_VOLUMEDOWN
    KM_CORE_VKEY_VOLUMEUP,        // 0x73 - KEY_VOLUMEUP
    0,                            // 0x74 - KEY_POWER
    KM_CORE_VKEY_EQUAL,           // 0x75 - KEY_KPEQUAL
    KM_CORE_VKEY_NPPLUS,          // 0x76 - KEY_KPPLUSMINUS
    KM_CORE_VKEY_PAUSE,           // 0x77 - KEY_PAUSE
    KM_CORE_VKEY_ZOOM,            // 0x78 - KEY_SCALE
    KM_CORE_VKEY_NPDOT,           // 0x79 - KEY_KPCOMMA
    KM_CORE_VKEY_HANGUL,          // 0x7a - KEY_HANGEUL
    KM_CORE_VKEY_HANJA,           // 0x7b - KEY_HANJA
    0,                            // 0x7c - KEY_YEN - ?
    KM_CORE_VKEY_LWIN,            // 0x7d - KEY_LEFTMETA
    KM_CORE_VKEY_RWIN,            // 0x7e - KEY_RIGHTMETA
    0,                            // 0x7f - KEY_COMPOSE - ?
    KM_CORE_VKEY_BROWSERSTOP,     // 0x80 - KEY_STOP
    KM_CORE_VKEY_BROWSERREFRESH,  // 0x81 - KEY_AGAIN
    0,                            // 0x82 - KEY_PROPS - ?
    0,                            // 0x83 - KEY_UNDO - ?
    0,                            // 0x84 - KEY_FRONT - ?
    0,                            // 0x85 - KEY_COPY - ?
    0,                            // 0x86 - KEY_OPEN - ?
    0,                            // 0x87 - KEY_PASTE - ?
    KM_CORE_VKEY_BROWSERSEARCH,   // 0x88 - KEY_FIND
    0,                            // 0x89 - KEY_CUT - ?
    KM_CORE_VKEY_HELP,            // 0x8a - KEY_HELP
    KM_CORE_VKEY_ALT,             // 0x8b - KEY_MENU
    0,                            // 0x8c - KEY_CALC - ?
    0,                            // 0x8d - KEY_SETUP - ?
    KM_CORE_VKEY_SLEEP,           // 0x8e - KEY_SLEEP
    0,                            // 0x8f - KEY_WAKEUP - ?
    0,                            // 0x90 - KEY_FILE - ?
    0,                            // 0x91 - KEY_SENDFILE - ?
    0,                            // 0x92 - KEY_DELETEFILE - ?
    0,                            // 0x93 - KEY_XFER - ?
    KM_CORE_VKEY_APP1,            // 0x94 - KEY_PROG1
    KM_CORE_VKEY_APP2,            // 0x95 - KEY_PROG2
    KM_CORE_VKEY_BROWSERHOME,     // 0x96 - KEY_WWW
    0,                            // 0x97 - KEY_MSDOS - ?
    KM_CORE_VKEY_SCROLL,          // 0x98 - KEY_COFFEE, KEY_SCREENLOCK
    0,                            // 0x99 - KEY_ROTATE_DISPLAY, KEY_DIRECTION - ?
    0,                            // 0x9a - KEY_CYCLEWINDOWS - ?
    KM_CORE_VKEY_MAIL,            // 0x9b - KEY_MAIL
    0,                            // 0x9c - KEY_BOOKMARKS - ?
    0,                            // 0x9d - KEY_COMPUTER - ?
    KM_CORE_VKEY_BROWSERBACK,     // 0x9e - KEY_BACK
    KM_CORE_VKEY_BROWSERFORWARD,  // 0x9f - KEY_FORWARD
    0,                            // 0xa0 - KEY_CLOSECD - ?
    0,                            // 0xa1 - KEY_EJECTCD - ?
    0,                            // 0xa2 - KEY_EJECTCLOSECD - ?
    KM_CORE_VKEY_MEDIANEXT,       // 0xa3 - KEY_NEXTSONG
    KM_CORE_VKEY_MEDIAPLAY,       // 0xa4 - KEY_PLAYPAUSE
    KM_CORE_VKEY_MEDIAPREV,       // 0xa5 - KEY_PREVIOUSSONG
    0,                            // 0xa6 - KEY_STOPCD - ?
    0,                            // 0xa7 - KEY_RECORD - ?
    0,                            // 0xa8 - KEY_REWIND - ?
    KM_CORE_VKEY_MEDIA,           // 0xa9 - KEY_PHONE
    0,                            // 0xaa - KEY_ISO - ?
    0,                            // 0xab - KEY_CONFIG - ?
    KM_CORE_VKEY_BROWSERHOME,     // 0xac - KEY_HOMEPAGE
    KM_CORE_VKEY_BROWSERREFRESH,  // 0xad - KEY_REFRESH
    0,                            // 0xae - KEY_EXIT - ?
    0,                            // 0xaf - KEY_MOVE - ?
    0,                            // 0xb0 - KEY_EDIT - ?
    0,                            // 0xb1 - KEY_SCROLLUP - ?
    ...
    0,                            // 0xc6 - unassigned
    0,                            // 0xc7 - unassigned
    KM_CORE_VKEY_MEDIAPLAY,       // 0xc8 - KEY_PLAYCD
    KM_CORE_VKEY_MEDIASTOP,       // 0xc9 - KEY_PAUSECD
    0,                            // 0xca - KEY_PROG3 - ?
    0,                            // 0xcb - KEY_PROG4 - ?
    0,                            // 0xcc - KEY_ALL_APPLICATIONS, KEY_DASHBOARD - ?
    0,                            // 0xcd - KEY_SUSPEND - ?
    0,                            // 0xce - KEY_CLOSE - ?
    KM_CORE_VKEY_MEDIAPLAY,       // 0xcf - KEY_PLAY
    ...
    0,                            // 0xd5 - KEY_SOUND - ?
    0,                            // 0xd6 - KEY_QUESTION - ?
    KM_CORE_VKEY_MAIL,            // 0xd7 - KEY_EMAIL
    0,                            // 0xd8 - KEY_CHAT - ?
    0,                            // 0xd9 - KEY_SEARCH - ?
    0,                            // 0xda - KEY_CONNECT - ?
    0,                            // 0xdb - KEY_FINANCE - ?
    ...
    KM_CORE_VKEY_MEDIA,           // 0xe2 - KEY_MEDIA
