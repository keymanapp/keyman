...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(GetKeyValFromKeyCodeTestParameters(
                          {u'a', u'b', u'c', u'd',  u'e', u'f',  u'g', u'h', u'i', u'j',    u'k',    u'l', u'm',
                           u'n', u'o', u'p', u'q',  u'r', u's',  u't', u'u', u'v', u'w',    u'x',    u'y', u'z',
                           u'0', u'1', u'2', u'3',  u'4', u'5',  u'6', u'7', u'8', u'9',    u'\000', u'`', u'-',
                           u'=', u'[', u']', u'\\', u';', u'\'', u',', u'.', u'/', u'\000', u'|'},
                          "us",
                          (LCTRLFLAG | RALTFLAG),
                          0)
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(GetKeyValFromKeyCodeTestParameters(
                          {u'A', u'B', u'C', u'D', u'E', u'F', u'G', u'H', u'I', u'J',    u'K',    u'L', u'M',
                           u'N', u'O', u'P', u'Q', u'R', u'S', u'T', u'U', u'V', u'W',    u'X',    u'Y', u'Z',
                           u')', u'!', u'@', u'#', u'$', u'%', u'^', u'&', u'*', u'(',    u'\000', u'~', u'_',
                           u'+', u'{', u'}', u'|', u':', u'"', u'<', u'>', u'?', u'\000', u'¦'},
                          "us",
                          (K_SHIFTFLAG | LCTRLFLAG | RALTFLAG),
                          0)
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(GetKeyValFromKeyCodeTestParameters(
                          {u'a',      u'b', u'c', u'd', u'e', u'f', u'g', u'h', u'i', u'j',    u'k', u'l',      u'm',
                           u'n',      u'o', u'p', u'q', u'r', u's', u't', u'u', u'v', u'w',    u'x', u'z',      u'y',
                           u'0',      u'1', u'2', u'3', u'4', u'5', u'6', u'7', u'8', u'9',    u' ', u'\xffff', u'ß',
                           u'\xffff', u'ü', u'+', u'#', u'ö', u'ä', u',', u'.', u'-', u'\000', u'<'},
                          "de",
                          0,
                          0)
                          .get_test_data()));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::ValuesIn(GetKeyValFromKeyCodeTestParameters(
                          {u'A',      u'B', u'C', u'D',  u'E', u'F', u'G', u'H', u'I', u'J',    u'K', u'L', u'M',
                           ...
                           u'\xffff', u'Ü', u'*', u'\'', u'Ö', u'Ä', u';', u':', u'_', u'\000', u'>'},
                          "de",
                          K_SHIFTFLAG,
                          0)
                          .get_test_data()));
...
INSTANTIATE_TEST_SUITE_P(
    ...
    GetKeyValFromKeyCodeTest,
    testing::ValuesIn(GetKeyValFromKeyCodeTestParameters(
                          {u'æ',      u'\xfffe', u'¢',      u'ð',      u'\xfffe', u'\xfffe', u'\xfffe', u'\xfffe', u'\xfffe',
                           u'\xffff', u'\xfffe', u'\xfffe', u'µ',      u'\xfffe', u'ø',      u'þ',      u'@',      u'¶',
                           u'\xfffe', u'\xfffe', u'\xfffe', u'\xfffe', u'\xfffe', u'«',      u'\xfffe', u'»',      u'}',
                           u'¹',      u'²',      u'³',      u'¼',      u'½',      u'¬',      u'{',      u'[',      u']',
                           u'\000',   u'\xfffe', u'\\',     u'\xffff', u'\xffff', u'~',      u'\xfffe', u'\xffff', u'\xffff',
                           u'·',      u'\xfffe', u'\xfffe', u'\000',   u'|'},
                          "de",
                          (LCTRLFLAG | RALTFLAG),
                          0)
                          .get_test_data()));
