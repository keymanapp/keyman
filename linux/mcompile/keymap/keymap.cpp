...
int append_other_ToVector(v_dw_3D &All_Vector,GdkKeymap * keymap) {
  ...
  for(int i =0; i< (int) All_Vector[1].size();i++) {
    ...
    All_Vector[1][i][0+1] = getKeyvalsOtherFromKeyCode(keymap,All_Vector[0][i][0],0);   //shift state: unshifted:0
    All_Vector[1][i][1+1] = getKeyvalsOtherFromKeyCode(keymap,All_Vector[0][i][0],1);   //shift state: shifted:1
