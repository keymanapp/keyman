...
/**
   ...
   * @param          keymap ptr to currently used (underlying) keyborad layout
...
/**
   ...
   * @param    keymap  ptr to ptr to currently used (underlying) keyborad layout
...
/**
   ...
   *          or the keyval obtained from Keycode and shiftstate and caps;
   */
