...
#define GTK_IM_CONTEXT_XIM(obj)              (GTK_CHECK_CAST ((obj), GTK_TYPE_IM_CONTEXT_XIM, GtkIMContextKMFL))
#define GTK_IM_CONTEXT_XIM_CLASS(klass)      (GTK_CHECK_CLASS_CAST ((klass), GTK_TYPE_IM_CONTEXT_XIM, GtkIMContextKMFLClass))
...
#define GTK_IM_CONTEXT_XIM_GET_CLASS(obj)    (GTK_CHECK_GET_CLASS ((obj), GTK_TYPE_IM_CONTEXT_XIM, GtkIMContextKMFLClass))


typedef struct _GtkIMContextKMFL       GtkIMContextKMFL;
typedef struct _GtkIMContextKMFLClass  GtkIMContextKMFLClass;

struct _GtkIMContextKMFLClass
{
