...
begin
  ...
  writeln(f, 'uses SetupStrings;'#13#10);

  sconst := 'const FLocaleStrings_'+BCP47ID+': TLocaleArray = ('#13#10;
  ...
  writeln(f,'   TLocaleManager.RegisterSetupStrings('''+BCP47+''', FLocaleStrings_'+BCP47ID+');');
  writeln(f, 'end.');
