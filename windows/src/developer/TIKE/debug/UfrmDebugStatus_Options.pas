...
procedure TfrmDebugStatus_Options.cbPlatformClick(Sender: TObject);
begin
...
procedure TfrmDebugStatus_Options.EnableControlsAndSetValues;
begin
...
procedure TfrmDebugStatus_Options.SetPlatform;
var
  p: string;
begin
  p := cbPlatformOS.Text;
