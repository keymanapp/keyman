...
if (!window['keyman']['ui']['name']) {
    ...
    try {
        ...
        ui.doFocus = function (someElement, focusing, activeControl) {
            ...
            var x, y, w, h, p;
            p = util['getAbsolute'](someElement);
            x = p['x'];
            y = p['y'];
        ...
        ui.registerEvents = function () {
            ...
            osk['addEventListener']('hide', function (byUser) {
                if (byUser['HiddenByUser'])
                    ui.oskButton._setSelected(false);
            });
        };
        /**
        ...
        ui.switchSingleKbd = function () {
            ...
            if (_v) {
                if (ui.keyboards.length == 0)
                    return;
                if (ui.lastActiveKeyboard < ui.keyboards.length && ui.lastActiveKeyboard >= 0)
                    nLastKbd = ui.lastActiveKeyboard;
        ...
        ui.button = function (_src, _caption, _selected) {
            ...
            /*private*/ this.__mouseover = function () {
                ...
                if (this._owningObject._onmouseover != null)
                    this._owningObject._onmouseover();
                this._owningObject.__updatestyle();
            };
            /*private*/ this.__mouseout = function () {
                ui.controllerHovered = false;
                this._owningObject._over = false;
                if (this._owningObject._onmouseout != null)
                    this._owningObject._onmouseout();
                this._owningObject.__updatestyle();
            };
        ...
        ui.updateKeyboardList = function () {
            ...
            // Single keyboard
                ...
                if (typeof (ui.keyboardMenu) != 'undefined')
                    delete ui.keyboardMenu;
            }
        ...
        ui.selectKbd = function (_kbd) {
            ...
            if (_kbd < 0) {
                ...
                _name = ui.keyboards[_kbd]._InternalName;
                _lgCode = ui.keyboards[_kbd]._LanguageCode;
                _index = ui.keyboards[_kbd]._Index;
            }
            keymanweb['setActiveKeyboard'](_name, _lgCode);
            keymanweb['focusLastActiveElement']();
            ui.kbdButton._setSelected(_name != '');
            if (_kbd >= 0)
                ui.lastActiveKeyboard = _kbd;
            return false;
        };
        /**
         * Function     updateMenu
        ...
        ui.updateMenu = function (kbdName, lgCode) {
            ...
            if (_k) {
                if (ui.selectedMenuItem != null)
                    ui.selectedMenuItem.className = '';
                _k.className = 'selected';
                ui.selectedMenuItem = _k;
            }
        ...
        util['addStyleSheet']("#KeymanWeb_KbdList {" +
            "display: block;" +
            "position: absolute;" +
        ...
        ui.createMenu = function () {
            if (typeof (ui.keyboardMenu) == 'undefined') // I2403 - Allow toggle design to be loaded twice
             {
                ...
                ui.keyboardMenu.innerHTML = ''; // I2403 - Allow toggle design to be loaded twice
            ...
            //if(!ui.initialized) // I2403 - Allow toggle design to be loaded twice
            if (ui.keyboardMenu.parentNode != ui.kbdButton.getElem())
                ui.kbdButton.getElem().appendChild(ui.keyboardMenu);
        };
