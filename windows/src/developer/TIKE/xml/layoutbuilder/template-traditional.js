    ...
    "layer": [
      {
        ...
        "row": [
          ...
          },
          {
            "id": 4,
            "key": [
              {"id": "K_SHIFT","text": "*Shift*","width": "160","sp": "1","nextlayer": "shift"},
              {"id": "K_Z","text":"z"},
              {"id": "K_X","text":"x"},
              {"id": "K_C","text":"c"},
              {"id": "K_V","text":"v"},
              ...
              {"id": "K_PERIOD","text": "."},
              {"id": "K_SLASH","text":"/"},
              {"id": "K_ENTER","text": "*Enter*","width":"145","sp": "1"}
            ]
          },
          {
            "id": 5,
            "key": [
              {"id": "K_LCONTROL","text": "*Ctrl*","width": "130","sp": "1"},
              {"id": "K_LOPT","text": "*Menu*","width": "140","sp": "1"},
      ...
      },
      {
        ...
        "row": [
          ...
          },
          {
            "id": 4,
            "key": [
              {"id": "K_SHIFT","text": "*Shift*","width": "160","sp": "2","nextlayer": "default"},
              {"id": "K_Z","text":"Z"},
              {"id": "K_X","text":"X"},
              {"id": "K_C","text":"C"},
              {"id": "K_V","text":"V"},
      ...
      },
      {
        ...
        "row": [
          ...
          },
          {
            "id": 4,
            "key": [
              {"id": "K_SHIFT","text": "*Shift*","width": "160","sp": "1"},
              {"id": "K_Z"},
              {"id": "K_X"},
              {"id": "K_C"},
              {"id": "K_V"},
          ...
          },
          {
            "id": 5,
            "key": [
              {"id": "K_LCONTROL","text": "*Ctrl*","width": "130","sp": "2"},
              {"id": "K_LOPT","text": "*Menu*","width": "140","sp": "1"},
              {"id": "K_LALT","text": "*Alt*","width": "130","sp": "1"},
              {"id": "K_SPACE","text": "","width": "675","sp": "0"},
              {"id": "K_RALT","text": "*AltGr*","width": "130","sp": "1"},
      ...
      },
      {
        ...
        "row": [
          ...
          },
          {
            "id": 4,
            "key": [
              {"id": "K_SHIFT","text": "*Shift*","width": "160","sp": "2"},
              {"id": "K_Z"},
              {"id": "K_X"},
              {"id": "K_C"},
              {"id": "K_V"},
