...
LRESULT _kmnGetMessageProc(int nCode, WPARAM wParam, LPARAM lParam)
{
  ...
  */
  ...
  if (mp->message == wm_keyman_keyevent && flag_ShouldSerializeInput  /*&& _td->lpActiveKeyboard*/) {
    if (wParam & PM_REMOVE) {
