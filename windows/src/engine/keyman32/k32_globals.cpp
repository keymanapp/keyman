...
BOOL Globals::InitSettings() {
  ...
  f_CoreIntegration = Reg_GetDebugFlag(REGDW_CoreIntegration, TRUE);
  SendDebugMessageFormat(0, sdmAIDefault, 0, "Globals::InitSettings - Coreintegration set in '" REGDW_CoreIntegration "' to %x", f_CoreIntegration);
