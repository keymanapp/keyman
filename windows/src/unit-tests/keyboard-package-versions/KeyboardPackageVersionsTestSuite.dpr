...
uses
  ...
  kmnProjectFile in '..\..\developer\TIKE\project\kmnProjectFile.pas',
  Project in '..\..\developer\TIKE\project\Project.pas',
  ProjectFile in '..\..\developer\TIKE\project\ProjectFile.pas',
  ProjectFiles in '..\..\developer\TIKE\project\ProjectFiles.pas',
  ProjectFileType in '..\..\developer\TIKE\project\ProjectFileType.pas',
  mrulist in '..\..\developer\TIKE\main\mrulist.pas',
  kmxfileconsts in '..\..\global\delphi\general\kmxfileconsts.pas',
  ProjectLoader in '..\..\developer\TIKE\project\ProjectLoader.pas',
  ProjectLog in '..\..\developer\TIKE\project\ProjectLog.pas',
  ProjectSaver in '..\..\developer\TIKE\project\ProjectSaver.pas',
...
{$ENDIF}
  try
    ...
    logger := TDUnitXConsoleLogger.Create(false); //true);
