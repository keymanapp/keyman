...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  <xsl:import href="../../ext/docbook/html/chunk.xsl"/>
...
<!--  <xsl:param name="chunker.output.encoding" select="utf-8" />-->
  ...
  <xsl:template match="redirect">
    <meta http-equiv="refresh"><xsl:attribute name='content'>0;url=<xsl:value-of select="@url" />.html</xsl:attribute></meta>
    <para>If you are not automatically redirected to the topic, please <a><xsl:attribute name='href'><xsl:value-of select="@url" />.html</xsl:attribute>click here</a>.</para>
  </xsl:template>
