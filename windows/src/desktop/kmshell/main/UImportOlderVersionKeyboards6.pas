(*
  Name:             UImportOlderVersionKeyboards6
  ...
  History:          30 Nov 2010 - mcdurdin - I2548 - Support for upgrading Desktop 7 to Desktop 8
                    ...
                    11 Jan 2011 - mcdurdin - I2642 - Installer uninstalls KM7 keyboards before upgrade of keyboards can happen
                    03 May 2011 - mcdurdin - I2890 - Record diagnostic data when encountering registry errors
                    26 Jun 2012 - mcdurdin - I3377 - KM9 - Update code references from 8.0 to 9.0
*)
unit UImportOlderVersionKeyboards6;

interface

procedure ImportOlderVersionKeyboards6(DoAdmin: Boolean);  // I2361
...
type
  TImportKeyman6Keyboard = class(TImportKeymanKeyboardBase)
  private
    function IsAddinPackage(const name: string): Boolean;
  public
    procedure Import;
  end;
...
procedure ImportOlderVersionKeyboards6(DoAdmin: Boolean);  // I2361
begin
  with TImportKeyman6Keyboard.Create(DoAdmin) do  // I2361
  try
    Import;
  finally
    Free;
...
function TImportKeyman6Keyboard.IsAddinPackage(const name: string): Boolean;
const
  names: array[0..8] of string = ('std_kmtip', 'std_richedit', 'std_wordlink',
    'free_kmtip', 'free_richedit', 'free_wordlink',
    'kmtip', 'richedit', 'wordlink');
var
  i: Integer;
begin
...
procedure TImportKeyman6Keyboard.Import;
var
...
begin
  ...
  try
    ...
    rootRead := SRegKey_UpgradeBackupPath + SRegKey_Keyman60_InstalledPackages;  // I2642
    ...
    begin
      ...
      for i := 0 to keys.Count - 1 do
        if not IsAddinPackage(keys[i]) then
        begin
          if FAdmin
    ...
    rootRead := SRegKey_UpgradeBackupPath + SRegKey_Keyman60_Keyboards;  // I2642
    ...
    begin
      rootRead := SRegKey_UpgradeBackupPath + SRegKey_Keyman60_ActiveKeyboards;  // I2642
