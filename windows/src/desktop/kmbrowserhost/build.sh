...
function do_build() {
  ...
  cp_if_exists "$WIN32_TARGET_PATH/kmbrowserhost.pdb" "$WINDOWS_PROGRAM_APP"
...
function do_install() {
  ...
  cp_if_exists "$WINDOWS_PROGRAM_APP/kmbrowserhost.pdb" "$INSTALLPATH_KEYMANAPP/kmbrowserhost.pdb"
}
