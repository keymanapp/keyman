...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		...
		<html>
			<head>
				...
				<script type="text/javascript">
					function hinticon()
					{
					alert("Don't click on this icon.  Look for a smaller version of the icon near the clock, usually at the bottom right hand corner of your screen.");
					}
				</script>
			</head>
        ...
        <xsl:value-of select="$locale/String[@Id='S_Hintbar4_p1a']" />
				...
				</img> <xsl:value-of select="$locale/String[@Id='S_Hintbar4_p1b']" />
				</td></tr></table>
			</body>
		</html>
	</xsl:template>
