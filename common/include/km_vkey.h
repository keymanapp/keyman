...
// #define VK_DECIMAL  0x2E //_S2 probably wrong 0x2E (which is actually the Windows VK_DELETE value, not the standard VK_DECIMAL
// which is 0x6E for the numpad decimal key)
