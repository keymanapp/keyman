(*
  ...
  Todo:             
  Notes:            
  History:          18 May 2012 - mcdurdin - I3309 - V9.0 - Migrate to Delphi XE2, VS2010, svn 1.7
*)
unit RegExpr;  // I3309
...
{$IFDEF VER210} {$DEFINE D2010} {$DEFINE D7} {$DEFINE D6} {$DEFINE D5} {$DEFINE D4} {$DEFINE D3} {$DEFINE D2} {$ENDIF} // D2010
{$IFDEF VER230} {$DEFINE DXE2} {$DEFINE D2010} {$DEFINE D7} {$DEFINE D6} {$DEFINE D5} {$DEFINE D4} {$DEFINE D3} {$DEFINE D2} {$ENDIF} // DXE2 // I3309
