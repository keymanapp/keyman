namespace Testing {
  ...
  export class TouchpathTurtle extends EventEmitter<EventMap> {
    ...
    private currentChop:  com.keyman.osk.CumulativePathStats = null;
    ...
    constructor(obj: InputSample | TouchpathTurtle) {
      ...
      if(!(obj instanceof TouchpathTurtle)) {
        ...
        this.currentStats = new com.keyman.osk.CumulativePathStats(obj);
      ...
      this.currentStats  = new com.keyman.osk.CumulativePathStats(obj.currentStats);
      this.currentChop   = new com.keyman.osk.CumulativePathStats(obj.currentChop);
