...
WORKER_TEST_BUNDLE_TARGET_FILENAME=build/lib/worker-main.wrapped-for-bundle.ts
...
if builder_start_action build; then
  ...
  cp "${WORKER_OUTPUT_FILENAME}" "${WORKER_OUTPUT}/worker-intermediate.js"
  wrap-worker-code LMLayerWorkerCode "${WORKER_OUTPUT}/worker-intermediate.js" > "${WORKER_OUTPUT_FILENAME}" || die
