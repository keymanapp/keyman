 ...
 *
 * This definition of CODE__SIZE_COM should be used instead of versions scattered all around the codebase
 */

#include <typeinfo>


const int CODE__SIZE_COM[] = {
   -1,   // undefined                0x00
    1,   // CODE_ANY                 0x01
    2,   // CODE_INDEX               0x02
    0,   // CODE_CONTEXT             0x03
...
static_assert(sizeof(CODE__SIZE_COM) / sizeof(CODE__SIZE_COM[0]) == (CODE_LASTCODE + 1), "Size of array CODE__SIZE_COM not correct");
