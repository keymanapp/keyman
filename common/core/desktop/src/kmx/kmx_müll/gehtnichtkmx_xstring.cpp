...
PKMX_WCHAR km::kbp::kmx::incxstr(PKMX_WCHAR p)
{
  ...
  {
    // UC_SENTINEL(FFFF) with \0 directly after FFFF
    if (*(p + 1) == 0)
      return p + 1;
    ...
    //  UC_SENTINEL(FFFF) followe by other
    switch (*(p + 1))
    {
    case CODE_ANY:						deltaptr = 1; break;
    case CODE_NOTANY:					deltaptr = 1; break;
    case CODE_INDEX:					deltaptr = 2; break;
    case CODE_USE:						deltaptr = 1; break;
    case CODE_DEADKEY:				deltaptr = 1; break;
    case CODE_CLEARCONTEXT:		deltaptr = 1; break;
    case CODE_CALL:						deltaptr = 1; break;
    case CODE_CONTEXTEX:			deltaptr = 1; break;
    case CODE_IFOPT:
      deltaptr = 3;
      break;
    case CODE_IFSYSTEMSTORE:	deltaptr = 3; break;
    case CODE_SETOPT:					deltaptr = 2; break;
    case CODE_SETSYSTEMSTORE:	deltaptr = 2; break;
    case CODE_RESETOPT:				deltaptr = 1; break;
    case CODE_SAVEOPT:				deltaptr = 1; break;
    default:									deltaptr = 1;
    }
