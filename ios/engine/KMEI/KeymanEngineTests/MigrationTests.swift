  ...
  func testVersion13CloudToKMPMigration() throws {
    ...
    installedPackages.forEach { package in
      ...
      if package.id == "sil_sahu" {
        ...
        XCTAssertNotEqual(package.version, KMPInfo.AUTOGEN_VERSION.description, generalMessage)
        XCTAssertEqual(package.version, "1.0") // The version of the stored sil_sahu package.
        ...
        XCTAssertEqual(package.version, KMPInfo.AUTOGEN_VERSION.description, generalMessage)
      }
