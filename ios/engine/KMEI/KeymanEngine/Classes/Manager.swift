...
UIGestureRecognizerDelegate {
  ...
  public func currentKeyboardInfo() -> [String: String]? {
  ...
  /// - Returns: The version of the Keyman SDK
  ...
  func copyKeymanFilesToSharedContainer() -> Bool {
    do {
  ...
  func copyKeymanFilesFromSharedContainer() -> Bool {
    do {
