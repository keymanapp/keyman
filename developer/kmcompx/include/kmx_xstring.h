...
/* ---- old  -> don`t I need new versions here ????
...
//const km_kbp_cp *u16cpy(km_kbp_cp *dst, const km_kbp_cp *src);  // TODO: deprecate all usages  Ursprung
...
//km_kbp_cp *u16tok(km_kbp_cp *p, km_kbp_cp ch, km_kbp_cp **ctx);			//not used _S2
