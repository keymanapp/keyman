...
struct KMX_FILE_STORE {
	...
	KMX_WCHART szName[SZMAX_STORENAME];	// the name of the store
	PKMX_WCHART dpString;	    				// from start of store structure
//FileStoreType fstType;
KMX_BOOL fIsStore;
...
struct KMX_FILE_GROUP {
	KMX_WCHART		szName[SZMAX_GROUPNAME];
	PKMX_FILE_KEY	dpKeyArray;         // address of first item in key array, from start of group structure
	PKMX_WCHART      dpMatch;             // from start of group structure
	PKMX_WCHART      dpNoMatch;           // from start of group structure
