(*
  ...
  Todo:             
  Notes:            
  History:          08 Jun 2012 - mcdurdin - I3309 - V9.0 - Migrate to Delphi XE2, VS2010, svn 1.7
*)
...
procedure THexaColorPicker.WMEraseBkgnd(var Message: TWMEraseBkgnd);
begin
 Message.Result := 1;
end;
...
function THexaColorPicker.HandleSlider(const Message: TWMMouse): Boolean;
var
 Shift: TShiftState;
 dY: Integer;
 R: TRect;
...
function THexaColorPicker.HandleBWArea(const Message: TWMMouse): Boolean;
var
 Index: Integer;
 Shift: TShiftState;
begin
...
function THexaColorPicker.HandleColorComb(const Message: TWMMouse): Boolean;
var
 Index: Integer;
 Shift: TShiftState;
begin
...
procedure THexaColorPicker.HandleCustomColors(var Message: TWMMouse);
begin
...
procedure THexaColorPicker.WMMouseMove(var Message: TWMMouseMove);
var
 Shift: TShiftState;
 Index: Integer;
 Colors: TCombArray;
...
procedure THexaColorPicker.WMLButtonDown(var Message: TWMLButtonDown);
begin
 inherited;
...
procedure THexaColorPicker.WMLButtonUp(var Message: TWMLButtonUp);
var
...
procedure THexaColorPicker.CMHintShow(var Message: TMessage);
var
 Index: Integer;
 Colors: TCombArray;
begin
...
procedure THexaColorPicker.CNKeyDown(var Message: TWMKeyDown);
var
 Shift: TShiftState;
 FInherited: boolean;
begin
