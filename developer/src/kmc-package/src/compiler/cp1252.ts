...
function buildUnicodeToCP1252() {
  if(UNICODE_CP1252[0x0001]) {
    return;
  }
  for(let i = 0; i < CP1252_UNICODE.length; i++) {
    UNICODE_CP1252[CP1252_UNICODE[i]] = i;
  }
}
...
// legit character because that's hopefully what the keyboard designer had
// intended...

// matches kmcmplib/src/cp1252.cpp, mcompile/mc_unicode.cpp

const CP1252_UNICODE: number[] = [
  /* 0x00 */ 0x0000,  // #NULL
  ...
  /* 0x81 */ 0x0081,  // #UNDEFINED --- diverges from CP1252.txt
  ...
  /* 0x8D */ 0x008D,  // #UNDEFINED --- diverges from CP1252.txt
  /* 0x8E */ 0x017D,  // #LATIN CAPITAL LETTER Z WITH CARON
  /* 0x8F */ 0x008F,  // #UNDEFINED --- diverges from CP1252.txt
  /* 0x90 */ 0x0090,  // #UNDEFINED --- diverges from CP1252.txt
  ...
  /* 0x9D */ 0x009D,  // #UNDEFINED --- diverges from CP1252.txt
