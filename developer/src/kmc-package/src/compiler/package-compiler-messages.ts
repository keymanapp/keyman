...
export class PackageCompilerMessages {
  ...
  static WARN_FloDataCouldNotBeRead = SevWarn | 0x002B;
  ...
  static WARN_FloDataIsInvalidFormat = SevWarn | 0x002C;
  ...
  static WARN_FontNotFoundInFlo = SevWarn | 0x002D;
  ...
  static WARN_FontFromFloIsNotFreelyDistributable = SevWarn | 0x002E;
  ...
  static WARN_FontInFloDoesNotHaveDefaultTtf = SevWarn | 0x002F;
  ...
  static WARN_FontInFloHasBrokenDefaultTtf = SevWarn | 0x0030;
  ...
  static WARN_FontInFloHasNoDownloadAvailable = SevWarn | 0x0031;
  ...
  static ERROR_FontFileCouldNotBeDownloaded = SevError | 0x0032;
  ...
  static HINT_SourceFileHasChanged = SevHint | 0x0033;
  ...
  static ERROR_InvalidSourceFileReference = SevError | 0x0034;
  ...
  static ERROR_FontInFloDoesNotHaveARecognizedGitHubUri = SevError | 0x0035;
  ...
  static ERROR_UriIsNotARecognizedGitHubUri = SevError | 0x0036;
  ...
  static ERROR_CouldNotRetrieveStableUriFromGitHub = SevError | 0x0037;
  ...
  static ERROR_UriIsNotARecognizedStableGitHubUri = SevError | 0x0038;
  ...
  static ERROR_SourceCannotBeSetForLocalFiles = SevError | 0x0039;
  ...
  static HINT_RemoteReferencesShouldBeVersion18Plus = SevHint | 0x003A;
