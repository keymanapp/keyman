...
import { CompilerErrorNamespace, CompilerErrorSeverity, CompilerEvent, CompilerMessageSpec, CompilerMessageObjectSpec, CompilerMessageDef as def, CompilerMessageSpecWithException, KeymanUrls } from "@keymanapp/developer-utils";
...
// Because we have several overlapping components generating messages here, we
// wrap the message generation functions with a source property, in order to
// verify that we use the correct pattern as far as possible
...
// messages from kmw compiler component (mw)
...
const mw = (code: number, message: string, o?: {filename?: string, line?: number}) : KmcKmnCompilerEvent  => ({
...
const mc = (code: number, message: string, detail?: string) : KmcKmnCompilerEvent => ({
...
const m = (code: number, message: string, detail?: string) : KmcKmnCompilerEvent => ({
  ...CompilerMessageSpec(code, message, detail),
  kmcKmnSource: "kmc-kmn",
});

const mx = (code: number, context: ObjectWithCompileContext, message: string, detail?: string) : KmcKmnCompilerEvent => ({
  ...CompilerMessageObjectSpec(code, context, message, detail),
  kmcKmnSource: "kmc-kmn",
});

const kmcKmnCompilerMessageSpecWithException = (code: number, message: string, exceptionVar: any, detail?: string): KmcKmnCompilerEvent => ({
...
export type KmcmpLibMessageParameters = {p:string[]};
...
export class KmnCompilerMessages {
  ...
  static Fatal_UnexpectedException = (o:{e: any}) => kmcKmnCompilerMessageSpecWithException(
  ...
  static Fatal_MissingWasmModule = (o:{e?: any}) => kmcKmnCompilerMessageSpecWithException(
  ...
  static Fatal_CallbacksNotSet = () => kmcKmnCompilerMessageSpecWithException(
  ...
  static Error_InvalidBegin                                   = () => mc(
    this.ERROR_InvalidBegin,
  ...
  static Error_NotSupportedInKeymanWebContext                 = (o:{line:number, code:String}) => mw(
    this.ERROR_NotSupportedInKeymanWebContext,
  ...
  static Error_NotSupportedInKeymanWebOutput                  = (o:{line:number, code:string}) => mw(
    this.ERROR_NotSupportedInKeymanWebOutput,
  ...
  static Error_NotSupportedInKeymanWebStore                   = (o:{code:string,store:string}) => mw(
    this.ERROR_NotSupportedInKeymanWebStore,
  ...
  static Error_VirtualCharacterKeysNotSupportedInKeymanWeb    = (o:{line:number}) => mw(
    this.ERROR_VirtualCharacterKeysNotSupportedInKeymanWeb,
  ...
  static Error_VirtualKeysNotValidForMnemonicLayouts          = (o:{line:number}) => mw(
    this.ERROR_VirtualKeysNotValidForMnemonicLayouts,
    `Virtual keys are not valid for mnemonic layouts`, o,
  );

  static ERROR_InvalidTouchLayoutFile                         = SevError | 0x059;
  static Error_InvalidTouchLayoutFile                         = (o:{filename:string, message: string}) => mw(
    this.ERROR_InvalidTouchLayoutFile,
    `Touch layout file ${def(o.filename)} is not valid: ${def(o.message)}`
  );

  static ERROR_TouchLayoutInvalidIdentifier                   = SevError | 0x05A;
  static Error_TouchLayoutInvalidIdentifier                   = (o:{keyId:string, platformName: string, layerId:string, address:KeyAddress}) => mw(
    this.ERROR_TouchLayoutInvalidIdentifier,
  ...
  static Error_DuplicateGroup                                 = (o:KmcmpLibMessageParameters) => mc(
  ...
  static Error_DuplicateStore                                 = (o:KmcmpLibMessageParameters) => mc(
  ...
  static Error_InvalidTarget                                  = (o:KmcmpLibMessageParameters) => mc(
  ...
  static Info_MinimumCoreEngineVersion                        = (o:KmcmpLibMessageParameters) => mc(
  ...
  static Warn_TouchLayoutMissingLayer                         = (o:{keyId:string, platformName:string, layerId:string, nextLayer:string, address:KeyAddress}) => mw(
    this.WARN_TouchLayoutMissingLayer,
  ...
  static Warn_TouchLayoutCustomKeyNotDefined                  = (o:{keyId:string, platformName:string, layerId:string, address:KeyAddress}) => mw(
    this.WARN_TouchLayoutCustomKeyNotDefined,
  ...
  static Warn_TouchLayoutMissingRequiredKeys                  = (o:{layerId:string, platformName:string, missingKeys:string}) => mw(
    this.WARN_TouchLayoutMissingRequiredKeys,
  ...
  static Warn_HelpFileMissing                                 = (o:{line:number, helpFilename:string, e:any}) => mw(
    this.WARN_HelpFileMissing,
    `File ${def(o.helpFilename)} could not be loaded: ${(o.e??'').toString()}`, o,
  );

  static WARN_EmbedJsFileMissing                              = SevWarn | 0x095;
  static Warn_EmbedJsFileMissing                              = (o:{line:number, jsFilename: string, e:any}) => mw(
    this.WARN_EmbedJsFileMissing,
  ...
  static Warn_ExtendedShiftFlagsNotSupportedInKeymanWeb       = (o:{line:number,flags:string}) => mw(
    this.WARN_ExtendedShiftFlagsNotSupportedInKeymanWeb,
    `Extended shift flags ${def(o.flags)} are not supported in KeymanWeb`, o,
  );

  static WARN_TouchLayoutUnidentifiedKey                      = SevWarn | 0x099;
  static Warn_TouchLayoutUnidentifiedKey                      = (o:{layerId:string, address:KeyAddress}) => mw(
    this.WARN_TouchLayoutUnidentifiedKey,
    `A key (${keyAddress(o.address)}) on layer "${def(o.layerId)}" has no identifier.`,
  );

  static HINT_UnreachableKeyCode                              = SevHint | 0x09A;
  static Hint_UnreachableKeyCode                              = (o:{line:number,key:string}) => mw(
    this.HINT_UnreachableKeyCode,
  ...
  static Warn_TouchLayoutFontShouldBeSameForAllPlatforms      = () => mw(
    this.WARN_TouchLayoutFontShouldBeSameForAllPlatforms,
  ...
  static Warn_DontMixChiralAndNonChiralModifiers              = () => mw(
    this.WARN_DontMixChiralAndNonChiralModifiers,
  ...
  static Warn_TouchLayoutSpecialLabelOnNormalKey              = (o:{keyId:string, platformName:string, layerId:string, label:string, address:KeyAddress}) => mw(
    this.WARN_TouchLayoutSpecialLabelOnNormalKey,
  ...
  static Warn_OptionStoreNameInvalid                          = (o:{name:string}) => mw(
    this.WARN_OptionStoreNameInvalid,
  ...
  static Hint_UnreachableRule                                 = (o:KmcmpLibMessageParameters) => mc(
  ...
  static Error_ContextExCannotReferenceIf                     = () => mc(
  ...
  static Error_ContextExCannotReferenceNul                    = () => mc(
  ...
  static Error_TextBeforeOrAfterNulInOutput                    = () => mc(
  ...
  static Error_NameMustBeAtLeastOneCharLong                   = () => mc(
    this.ERROR_NameMustBeAtLeastOneCharLong,
    `The name parameter is required`,
  );

  static ERROR_NameMustBeAtMostNCharsLong                     = SevError | 0x0B5;
  static Error_NameMustBeAtMostNCharsLong                     = (o: KmcmpLibMessageParameters) => mc(
    this.ERROR_NameMustBeAtMostNCharsLong,
    `The referenced name '${def(o.p?.[0])}' must be at most ${def(o.p?.[1])} characters long`,
  );

  static ERROR_NameContainsInvalidCharacter                   = SevError | 0x0B6;
  static Error_NameContainsInvalidCharacter                   = (o: KmcmpLibMessageParameters) => mc(
    this.ERROR_NameContainsInvalidCharacter,
    `The referenced name '${def(o.p?.[0])}' contains an invalid character`,
  ...
  static Error_NameMustNotContainSpaces                       = (o: KmcmpLibMessageParameters) => mc(
    this.ERROR_NameMustNotContainSpaces,
    `The referenced name '${def(o.p?.[0])}' must not contain spaces`,
    `Names (or identifiers) must not contain spaces, commas, parentheses,
    square brackets, control characters, or Unicode non-characters.`
  );

  static ERROR_NameMustNotContainComma                        = SevError | 0x0B8;
  static Error_NameMustNotContainComma                        = (o: KmcmpLibMessageParameters) => mc(
    this.ERROR_NameMustNotContainComma,
    `The referenced name '${def(o.p?.[0])}' must not contain commas`,
    `Names (or identifiers) must not contain spaces, commas, parentheses,
    square brackets, control characters, or Unicode non-characters.`
  );

  static ERROR_NameMustNotContainParentheses                  = SevError | 0x0B9;
  static Error_NameMustNotContainParentheses                  = (o: KmcmpLibMessageParameters) => mc(
    this.ERROR_NameMustNotContainParentheses,
    `The referenced name '${def(o.p?.[0])}' must not contain opening or closing parentheses`,
    `Names (or identifiers) must not contain spaces, commas, parentheses,
    square brackets, control characters, or Unicode non-characters.`
  );

  static ERROR_NameMustNotContainSquareBrackets               = SevError | 0x0BA;
  static Error_NameMustNotContainSquareBrackets               = (o: KmcmpLibMessageParameters) => mc(
    this.ERROR_NameMustNotContainSquareBrackets,
    `The referenced name '${def(o.p?.[0])}' must not contain opening or closing square brackets`,
    `Names (or identifiers) must not contain spaces, commas, parentheses,
    square brackets, control characters, or Unicode non-characters.`
  );
  ...
  // static Fatal_Break                                          = () => mc(this.FATAL_Break, `Compiler interrupted by user`);

  // ------------------------------------------------------------------------------------------------
  // end of kmcmplib messages
  // ------------------------------------------------------------------------------------------------
};
