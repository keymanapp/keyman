...
export class Lexer {
  ...
  private static scanRecognisers = [
    ...
    new ScanRecogniser(TokenTypes.BASELAYOUT_SHORTCUT, /^baselayout(?=\()/i,                                 true),
    new ScanRecogniser(TokenTypes.LAYER_SHORTCUT,      /^layer(?=\()/i,                                      true),
    new ScanRecogniser(TokenTypes.PLATFORM_SHORTCUT,   /^platform(?=\()/i,                                   true),
    new ScanRecogniser(TokenTypes.ANY,                 /^any(?=\()/i,                                        true),
    new ScanRecogniser(TokenTypes.BEEP,                /^beep(?![a-z])/i,                                       true),
    new ScanRecogniser(TokenTypes.BEGIN,               /^begin(?![a-z])/i,                                      true),
    new ScanRecogniser(TokenTypes.CALL,                /^call(?=\()/i,                                       true),
    new ScanRecogniser(TokenTypes.CONTEXT,             /^context(?![a-z])/i,                                    true),
    new ScanRecogniser(TokenTypes.DEADKEY,             /^(deadkey|dk)(?=\()/i,                               true),
    new ScanRecogniser(TokenTypes.GROUP,               /^group(?=\()/i,                                      true),
    new ScanRecogniser(TokenTypes.IF,                  /^if(?=\()/i,                                         true),
    new ScanRecogniser(TokenTypes.INDEX,               /^index(?=\()/i,                                      true),
    new ScanRecogniser(TokenTypes.MATCH,               /^match(?![a-z])/i,                                      true),
    new ScanRecogniser(TokenTypes.NOMATCH,             /^nomatch(?![a-z])/i,                                    true),
    new ScanRecogniser(TokenTypes.NOTANY,              /^notany(?=\()/i,                                     true),
    new ScanRecogniser(TokenTypes.NUL,                 /^nul(?![a-z])/i,                                        true),
    new ScanRecogniser(TokenTypes.OUTS,                /^outs(?=\()/i,                                       true),
    new ScanRecogniser(TokenTypes.RESET,               /^reset(?=\()/i,                                      true),
    new ScanRecogniser(TokenTypes.RETURN,              /^return(?![a-z])/i,                                     true),
    new ScanRecogniser(TokenTypes.SAVE,                /^save(?=\()/i,                                       true),
    new ScanRecogniser(TokenTypes.SET,                 /^set(?=\()/i,                                        true),
    new ScanRecogniser(TokenTypes.STORE,               /^store(?=\()/i,                                      true),
    new ScanRecogniser(TokenTypes.USE,                 /^use(?=\()/i,                                        true),
