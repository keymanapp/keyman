...
export enum NodeType {
  ...
  DEADKEYNAME           = "DEADKEYNAME",         // https://help.keyman.com/developer/language/reference/deadkey
  ...
  GROUPNAME             = "GROUPNAME",           // https://help.keyman.com/developer/language/reference/group
  ...
  INPUT_CONTEXT         = "INPUT_CONTEXT",       // https://help.keyman.com/developer/language/guide/rules
  ...
  KEYSTROKE             = "KEYSTROKE",           // https://help.keyman.com/developer/language/guide/rules
  ...
  LHS                   = "LHS",                 // https://help.keyman.com/developer/language/guide/rules
  LINE                  = "LINE",                // https://help.keyman.com/developer/language/guide/long-lines
  ...
  OFFSET                = "OFFSET",              // https://help.keyman.com/developer/language/reference/_index
  ...
  PRODUCTION            = "PRODUCTION",          // https://help.keyman.com/developer/language/guide/rules
  ...
  STORENAME             = "STORENAME",           // https://help.keyman.com/developer/language/reference/store
  STORES                = "STORES",
  ...
  USING_KEYS            = "USING_KEYS",          // https://help.keyman.com/developer/language/reference/group
  ...
  VIRTUAL_KEY           = "VIRTUAL_KEY",         // https://help.keyman.com/developer/language/guide/virtual-keys
