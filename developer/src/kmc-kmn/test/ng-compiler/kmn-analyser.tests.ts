...
describe("KMN Analyser Tests", () => {
  ...
  describe("Analyser Tests", () => {
    it("can parse (part of) Khmer Angkor correctly", () => {
      ...
      assert.equal(usingKeysProductionNodes.length, 12);
