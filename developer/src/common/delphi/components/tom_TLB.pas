...
// $Rev: 52393 $
// File generated on 4/03/2026 10:48:24 AM from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Windows\SysWOW64\RICHED20.dll (1)
...
// *********************************************************************//
  ITextDocument = interface(IDispatch)
    ...
    procedure Open(const pVar: OleVariant; Flags: Integer; CodePage: Integer); safecall;
    procedure Save(const pVar: OleVariant; Flags: Integer; CodePage: Integer); safecall;
...
// *********************************************************************//
  ITextDocumentDisp = dispinterface
    ...
    procedure Open(const pVar: OleVariant; Flags: Integer; CodePage: Integer); dispid 7;
    procedure Save(const pVar: OleVariant; Flags: Integer; CodePage: Integer); dispid 8;
...
// *********************************************************************//
  ITextRange = interface(IDispatch)
    ...
    function MoveWhile(const Cset: OleVariant; Count: Integer): Integer; safecall;
    function MoveStartWhile(const Cset: OleVariant; Count: Integer): Integer; safecall;
    function MoveEndWhile(const Cset: OleVariant; Count: Integer): Integer; safecall;
    function MoveUntil(const Cset: OleVariant; Count: Integer): Integer; safecall;
    function MoveStartUntil(const Cset: OleVariant; Count: Integer): Integer; safecall;
    function MoveEndUntil(const Cset: OleVariant; Count: Integer): Integer; safecall;
    ...
    procedure Paste(const pVar: OleVariant; Format: Integer); safecall;
    function CanPaste(const pVar: OleVariant; Format: Integer): Integer; safecall;
...
// *********************************************************************//
  ITextRangeDisp = dispinterface
    ...
    function MoveWhile(const Cset: OleVariant; Count: Integer): Integer; dispid 548;
    function MoveStartWhile(const Cset: OleVariant; Count: Integer): Integer; dispid 549;
    function MoveEndWhile(const Cset: OleVariant; Count: Integer): Integer; dispid 550;
    function MoveUntil(const Cset: OleVariant; Count: Integer): Integer; dispid 551;
    function MoveStartUntil(const Cset: OleVariant; Count: Integer): Integer; dispid 552;
    function MoveEndUntil(const Cset: OleVariant; Count: Integer): Integer; dispid 553;
    ...
    procedure Paste(const pVar: OleVariant; Format: Integer); dispid 566;
    function CanPaste(const pVar: OleVariant; Format: Integer): Integer; dispid 567;
...
// *********************************************************************//
  ITextMsgFilter = interface(IUnknown)
    ...
    function AttachDocument(var hwnd: _RemotableHandle; const pTextDoc: ITextDocument2): HResult; stdcall;
