...
export default class KMXBuilder {
  ...
  constructor(private file: KMXFile, private version: KMXPlusVersion, private writeDebug: boolean) {
  }
  ...
  private buildKMXPlus(base: number) {
    ...
    const plusbuilder: KMXPlusBuilder = new KMXPlusBuilder(this.file, this.version, this.writeDebug);
