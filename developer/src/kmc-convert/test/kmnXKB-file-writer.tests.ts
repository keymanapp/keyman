...
describe('KmnXKBFileWriter', function () {
  ...
  describe("Xkb-kmn: writeKmnFileHeader() ", function () {
    const sut = new XkbToKmnConverter(compilerTestCallbacks, compilerTestOptions);
    const sutR = new XkbFileReader(compilerTestCallbacks);
    const sutW = new KmnXKBFileWriter(compilerTestCallbacks, compilerTestOptions);
    const inputFilename = makePathToFixture('../data/tests-xkb-kmn/Test.xkb');
  ...
  describe('Xkb-kmn: convertToUnicodeCharacter ', function () {
    const sutW = new KmnXKBFileWriter(compilerTestCallbacks, compilerTestOptions);
    [
...
//..................................................................
  ...
  describe('Xkb-kmn: reviewRules messages', function () {
    const sutW = new KmnXKBFileWriter(compilerTestCallbacks, compilerTestOptions);
    [
  ...
  describe('Xkb-kmn: reviewRules messages duplicate and ambiguous', function () {
    const sutW = new KmnXKBFileWriter(compilerTestCallbacks, compilerTestOptions);
    [
      //all
      [[
  ...
  describe('Xkb-kmn: reviewRules messages duplicate and ambiguous with Extra warning', function () {
    const sutW = new KmnXKBFileWriter(compilerTestCallbacks, compilerTestOptions);
    [[[
  ...
  describe('Xkb-kmn: write from intermediate data array', function () {
    const sutW = new KmnXKBFileWriter(compilerTestCallbacks, compilerTestOptions);
    [
      [
