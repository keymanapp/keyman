...
![alt text]( minimal_C0kl.png)
![alt text]( minimal_C0ru.png)
_<left>minimal example C0<cleft>_<br><br><br><br><br>

![alt text]( minimal_C1kl.png)
![alt text]( minimal_C1ru.png) _<left>minimal example C1<left>_<br><br><br><br><br>

![alt text]( minimal_C2kl.png)  _<left>minimal example C2<left>_
![alt text]( howToReadC2.png)  _<left>minimal example C2<left>_<br><br><br><br><br>

![alt text]( minimal_C3.png)
