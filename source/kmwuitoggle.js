...
// British Library integration of KeymanWeb user interface.  Shows a keyboard selection button and an On Screen Keyboard toggle button next to the active edit control
