 ...
 *
 * Tests for the options API family of functions.
 */
#include <cstdlib>
#include <string>
...
TEST(OptionsApi, ListSizeIsCorrect) {
...
TEST(OptionsApi, EmptyListIsHandledCorrectly) {
...
TEST(OptionsApi, StateOptionsUpdateSetsStateCorrectly) {
  km::core::mock_processor mock_processor(test_kb_path);
