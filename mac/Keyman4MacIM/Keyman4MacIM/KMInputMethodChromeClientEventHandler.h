//
//  KMInputMethodChromeClientEventHandler.h
//  Keyman4MacIM
// This class is used for the Google Chrome browser to get specific behavior needed to improve behavior for some sites.
//
