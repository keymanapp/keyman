...
#
# Available build configurations and VCS identifeirs; identifiers are somewhat inconsistent due 
...
#
# TODO: these following entries relate to trigger-builds.sh and
#       at some point that script should be updated to use these
#       definitions rather than having them inline.
#
# Master (Alpha) Build Configurations

bc_master_android=KeymanAndroid_Build
bc_master_ios=Keyman_iOS_Master
bc_master_linux=KeymanLinux_Master
...
bc_beta_linux=KeymanLinux_Beta
