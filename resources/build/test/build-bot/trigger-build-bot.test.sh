...
readonly SKIP_ALL_EXCEPT_ANDROID_EXPECTED='[ios]="skip" [web]="skip" [linux]="skip" [common_mac]="skip" [common_windows]="skip" [mac]="skip" [windows]="skip" [common_web]="skip" [android]="release" [developer]="skip" [common_linux]="skip"'
...
test_build_bot_check_messages() {
  ...
  _do_test_build_bot_check_messages_file 14013 "[windows]=release" "${SKIP_ALL_EXCEPT_ANDROID_EXPECTED}"
