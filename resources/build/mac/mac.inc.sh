...
function _mac_generate_xcode_environment_definition_script() {
    ...
    # Ensure the autogenerated file may be successfully run/included by xcode-utils.inc.sh.
...
# each script phase will append to the log file, until printXCodeBuildScriptLogs
