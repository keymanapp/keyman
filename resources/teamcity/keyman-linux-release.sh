...
function publish_to_downloads() {
  ...
  local RSYNC_PATH=%downloads_rsync_path%
  local RSYNC_USER=%downloads_rsync_user%
  local RSYNC_HOST=%downloads_rsync_host%
  local RSYNC_ROOT=%downloads_rsync_root%
