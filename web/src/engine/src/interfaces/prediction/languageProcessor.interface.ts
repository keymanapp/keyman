...
import { type ProcessorAction, type Transcription } from "keyman/engine/keyboard";
...
export interface LanguageProcessorSpec extends EventEmitter<LanguageProcessorEventMap> {
   ...
   * @returns
   */
  applySuggestion(suggestion: LexicalModelTypes.Suggestion, textStore: TextStoreLanguageProcessorInterface, getLayerId: () => string, processorAction?: ProcessorAction): {
