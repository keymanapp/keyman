...
export class LanguageProcessor extends EventEmitter<LanguageProcessorEventMap> {
  ...
  public applySuggestion(
    ...
    let resultBehavior: ProcessorAction;
    ...
    if(suggestion.appendedTransform) {
      ...
      if(processorAction?.transcription?.transform == suggestion.appendedTransform) {
        ...
        resultBehavior = new ProcessorAction();
        Object.assign(resultBehavior, processorAction);
    ...
    return {
      ...
      appendedProcessorAction: resultBehavior
    };
  }
