...
import { KeyboardMinimalInterface, DefaultOutputRules, MinimalKeymanGlobal, SyntheticTextStore } from 'keyman/engine/keyboard';
...
describe('InputProcessor', function() {
  ...
  describe('efficiency tests', function() {
    let testDistribution: any[] = [];
    let keyboardWithHarness: KeyboardMinimalInterface;
    ...
    this.beforeAll(async function() {
      ...
      keyboardWithHarness = { ...keyboardLoader.harness, activeKeyboard: keyboard, variableStoreSerializer: new VariableStoreTestSerializer() };
    });
