...
import { generateSubsetId, LegacyQuotientSpur, models, LegacyQuotientRoot, SearchQuotientNode, PathInputProperties, SearchQuotientSpur } from '@keymanapp/lm-worker/test-index';
...
describe('SearchQuotientSpur', () => {
  ...
  describe('hasInputs()', () => {
    it('matches an empty array on root SearchQuotientSpurs', () => {
  ...
  describe('split()', () => {
    describe(`on token comprised of single-char transforms:  [crt][ae][nr][t]`, () => {
      ...
      it('splits properly at index 0', () => {
        ...
        assert.notEqual(head, pathToSplit.constituentPaths[0][0]);
