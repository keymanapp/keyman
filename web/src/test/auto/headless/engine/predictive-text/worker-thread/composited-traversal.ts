...
import { SearchKey, TrieBuilder } from '@keymanapp/models-templates';
import { models } from '@keymanapp/lm-worker/test-index';

import CompositedTraversal = models.CompositedTraversal;

const simpleLexicalModel = (function() {
  const builder = new TrieBuilder((str) => str as SearchKey);
