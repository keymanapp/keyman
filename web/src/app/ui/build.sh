...
compile_and_copy() {
  ...
  cp "${KEYMAN_ROOT}/web/build/engine/core-processor/obj/import/core/"km-core.{mjs,wasm} "${KEYMAN_ROOT}/web/build/app/ui/debug/"
  cp "${KEYMAN_ROOT}/web/build/engine/core-processor/obj/import/core/"km-core.{mjs,wasm} "${KEYMAN_ROOT}/web/build/app/ui/release/"
