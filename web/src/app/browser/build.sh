...
compile_and_copy() {
  ...
  cp "${KEYMAN_ROOT}/web/build/engine/core-adapter/obj/import/core/"km-core.{js,wasm} "${KEYMAN_ROOT}/web/build/app/browser/debug/"
  cp "${KEYMAN_ROOT}/web/build/engine/core-adapter/obj/import/core/"km-core.{js,wasm} "${KEYMAN_ROOT}/web/build/app/browser/release/"
