  ...
  export class BatchRenderer {
    ...
    createKeyboardHeader(kbd, loaded: boolean): HTMLDivElement {
      ...
      if(loaded) {
        ...
        eleDescription.appendChild(document.createTextNode('Font:  ' + window['keyman'].textProcessor.activeKeyboard.KV.F));
    ...
    private processKeyboard(kbd) {
      ...
      return p.then(function() {
        ...
        if(isMobile) {
          ...
          layers = keyman.textProcessor.activeKeyboard.KV.KLS;
        }
