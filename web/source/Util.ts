...
namespace Keyman {
  ...
  goog.exportSymbol("Keyman.Device", Device);
  ...
  /**
   * This section provides calls needed to export our established API elements.
   * Closure can work with these instructions to prevent minification from eliminating these names.
   */
  goog.exportSymbol("Keyman.Util", Util);
  // Interestingly, fields do not minify properly AT ALL.  Beware!
  //goog.exportSymbol("Keyman.Util.prototype.device", Util.prototype.device);
  //goog.exportSymbol("Keyman.Util.prototype.physicalDevice", Util.prototype.physicalDevice);
  goog.exportSymbol("Keyman.Util.prototype.attachDOMEvent", Util.prototype.attachDOMEvent);
  goog.exportSymbol("Keyman.Util.prototype.detachDOMEvent", Util.prototype.detachDOMEvent);
  goog.exportSymbol("Keyman.Util.prototype.getOption", Util.prototype.getOption);
  goog.exportSymbol("Keyman.Util.prototype.setOption", Util.prototype.setOption);
  goog.exportSymbol("Keyman.Util.prototype.getAbsoluteX", Util.prototype._GetAbsoluteX);
  goog.exportSymbol("Keyman.Util.prototype.getAbsoluteY", Util.prototype._GetAbsoluteY);
  goog.exportSymbol("Keyman.Util.prototype.getAbsolute", Util.prototype._GetAbsolute);
  goog.exportSymbol("Keyman.Util.prototype.createElement", Util.prototype.createElement);
  goog.exportSymbol("Keyman.Util.prototype.getIEVersion", Util.prototype._GetIEVersion);
  goog.exportSymbol("Keyman.Util.prototype.isTouchDevice", Util.prototype.isTouchDevice);
  goog.exportSymbol("Keyman.Util.prototype.createShim", Util.prototype.createShim);
  goog.exportSymbol("Keyman.Util.prototype.showShim", Util.prototype.showShim);
  goog.exportSymbol("Keyman.Util.prototype.hideShim", Util.prototype.hideShim);
  goog.exportSymbol("Keyman.Util.prototype.rgba", Util.prototype.rgba);
  goog.exportSymbol("Keyman.Util.prototype.addStyleSheet", Util.prototype.addStyleSheet);
  goog.exportSymbol("Keyman.Util.prototype.removeStyleSheet", Util.prototype.removeStyleSheet);
  goog.exportSymbol("Keyman.Util.prototype.linkStyleSheet", Util.prototype.linkStyleSheet);
  goog.exportSymbol("Keyman.Util.prototype.addFontFaceStyleSheet", Util.prototype.addFontFaceStyleSheet);
  goog.exportSymbol("Keyman.Util.prototype.loadCookie", Util.prototype.loadCookie);
  goog.exportSymbol("Keyman.Util.prototype.saveCookie", Util.prototype.saveCookie);
  goog.exportSymbol("Keyman.Util.prototype.toNumber", Util.prototype.toNumber);
  goog.exportSymbol("Keyman.Util.prototype.toFloat", Util.prototype.toFloat);
  goog.exportSymbol("Keyman.Util.prototype.toNzString", Util.prototype.nzString);
  goog.exportSymbol("Keyman.Util.prototype.alert", Util.prototype.alert);
}