namespace com.keyman.osk {
  ...
  export class LanguageMenu {
    ...
    show() {
      ...
      this.shim=util._CreateElement('div');
      this.shim.id='kmw-language-menu-background';
      this.shim.addEventListener('touchstart', function(e) {
          e.preventDefault();
          lgList.hide();
      ...
      mx.addEventListener('touchstart',function(e){
        lgList.scrollToLanguage(e, m2, m3);
      }, false);
      ...
      for(k=0; k<langs.length; k++) {
        ...
        if(lgBar.kList.length > 1) {
          ...
          lgBar.ontouchend=function(e) {
            ...
            lgMenu.adjust(this.parentNode.className=='kbd-list-closed'?0:this.kList.length);
          }
    ...
    addKeyboard(kbd, kb, unique: boolean) {
      ...
      var touchStart=function(e) {
        ...
        lgList.scrolling=false;
        lgList.y0=e.touches[0].pageY;//osk.lgList.childNodes[0].scrollTop;
        return true;
      };
      ...
      var touchMove=function(e: TouchEvent) {
        e.stopImmediatePropagation();
        var scroller=<HTMLElement>lgList.lgList.childNodes[0],
      ...
      var touchEnd=function(e: TouchEvent) {
        ...
        else
        {
          ...
          lgList.lgList.style.display='none'; //still allows blank menu momentarily on selection
          lgList.keyman.keyboardManager._SetActiveKeyboard(this.kn,this.kc,true);
          lgList.keyman.keyboardManager.doKeyboardChange(this.kn,this.kc);
          lgList.keyman.domManager.focusLastActiveElement();
          lgList.hide();

          // Update the OSK with the new keyboard
          lgList.keyman.osk._Show();
        }
        return true;
      };
    ...
    hide() {
      ...
      if(this.lgList) {
        ...
        window.setTimeout(function(){
          if(lgList != null && typeof lgList != 'undefined') {
            document.body.removeChild(lgList.shim);
            document.body.removeChild(lgList.lgList);
          }
          osk.lgList=null;
        },500);
      }
