...
function Keyboard_test_deadkeys()
{
  ...
  this.g_main=function(t,e) {
    ...
    if(k.KKM(e, 0x4000, 0xBE)&&k.KCM(6,t,"(o)",3)&&k.KDM(3,t,18)&&k.KCM(3,t,"(o)",3)) {   // Line 47
      r=m=1;
      k.KO(6,t,"dk(o)");
    }
    else if(k.KKM(e, 0x4000, 0xBE)&&k.KDM(3,t,18)&&k.KCM(3,t,"(m)",3)) {   // Line 41
      r=m=1;
      k.KO(3,t,"dk(m)");
    }
    else if(k.KKM(e, 0x4000, 0xBE)&&k.KCM(3,t,"(n)",3)&&k.KDM(0,t,18)) {   // Line 44
      r=m=1;
      k.KO(3,t,"dk(n)");
    }
    else if(k.KKM(e, 0x4000, 0xBE)&&k.KDM(0,t,16)&&k.KDM(0,t,17)) {   // Line 36
      r=m=1;
      k.KO(0,t,"(a)-(s)");
    }
    else if(k.KKM(e, 0x4000, 0xBE)&&k.KDM(0,t,17)&&k.KDM(0,t,16)) {   // Line 37
      r=m=1;
      k.KO(0,t,"(s)+(a)");
    }
    ...
    else if(k.KKM(e, 0x4010, 0x42)&&k.KDM(0,t,16)) {   // Line 90
      r=m=1;
      k.KO(0,t,"ab");
      k.KDO(-1,t,21);
    }
    else if(k.KKM(e, 0x4010, 0x43)&&k.KDM(0,t,22)) {   // Line 91
      r=m=1;
      k.KO(0,t,"abc");
    }
    else if(k.KKM(e, 0x4010, 0x44)&&k.KCM(3,t,"abc",3)) {   // Line 92
      r=m=1;
      k.KO(3,t,"$abc$d");
    }
    else if(k.KKM(e, 0x4010, 0x45)&&k.KCM(3,t,"ab",2)&&k.KDM(1,t,23)&&k.KCM(1,t,"d",1)) {   // Line 93
      r=m=1;
      k.KO(3,t,"success");
    }
    ...
    else if(k.KKM(e, 0x4000, 0x42)&&k.KDM(0,t,2)) {   // Line 78
      r=m=1;
      k.KO(0,t,"dead2");
    }
    else if(k.KKM(e, 0x4000, 0x42)&&k.KDM(0,t,1)) {   // Line 79
      r=m=1;
      k.KO(0,t,"dead1");
    }
    else if(k.KKM(e, 0x4000, 0x42)&&k.KDM(0,t,4)) {   // Line 83
      r=m=1;
      k.KO(0,t,"dead4");
    }
    else if(k.KKM(e, 0x4000, 0x42)&&k.KDM(0,t,3)) {   // Line 84
      r=m=1;
      k.KO(0,t,"dead3");
    }
